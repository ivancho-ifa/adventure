...
<html>
	...
	<body>
		...
		<div style="width:1000px; margin:auto; margin-bottom:400px" >
			<div style="width:200px; float:left">
				<table cellpadding="0" cellspacing="0" width="1000px">
					<tr>
						<td style="font-size:20px; font-family:Lucida Calligraphy; color:#09F">
							<b>Категория</b>
						</td>
					</tr>
			...
			<div style="width:800px; float:left">
				<table cellpadding="0px" cellspacing="0" width="1000px">
					<tr><td class="headingText">Подкатегории</td></tr>
							...
							<tr>
								...
								<td>
									<table border="0" width="100px" bordercolor="#FF6666">
										...
										<tr>
											<td align="center" style="background-color:#60B0E6; font-family:Lucida Calligraphy">
												<a href="package.php?subcatid=<?php echo $data[0];?>"><font color="#FFFFFF">Виж повече</font></a>
											</td>
										</tr>
									</table>
								</td>
